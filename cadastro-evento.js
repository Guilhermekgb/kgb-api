...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function aplicarClienteVindoDoCadastroSeTiver() {
    const qs = new URLSearchParams(location.search);
...
function salvarAnotacaoEvento() {
  ...
  async function __getNomeUsuarioAtual(){
    try { const u = await (window.getUsuarioAtualAsync ? window.getUsuarioAtualAsync() : Promise.resolve(window.__KGB_USER_CACHE || null)); return (u && u.nome) ? u.nome : "—"; } catch { return "—"; }
  }
