...
function carregarDoLocalStorage() {
  try { produtos   = JSON.parse(localStorage.getItem("produtosBuffet"))   || []; } catch { produtos = []; }
  try { adicionais = JSON.parse(localStorage.getItem("adicionaisBuffet")) || []; } catch { adicionais = []; }
  try { servicos   = JSON.parse(localStorage.getItem("servicosBuffet"))   || []; } catch { servicos = []; }
}
