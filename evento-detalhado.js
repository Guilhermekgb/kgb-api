              ...
              try {
                ...
                try{
                  if (window.storageAdapter && typeof window.storageAdapter.setJSON === 'function'){
                    ...
                    try{ (() => { try{ if(window.storageAdapter && typeof window.storageAdapter.setJSON === 'function'){ window.storageAdapter.setJSON('fotosClientes', index); } else if(window.storageAdapter && typeof window.storageAdapter.setRaw === 'function'){ try{ window.storageAdapter.setRaw('fotosClientes', JSON.stringify(index)); }catch(e){} } else { try{ (typeof window.setFotosMap==='function' ? window.setFotosMap(index) : localStorage.setItem('fotosClientes', JSON.stringify(index))); }catch(e){} } }catch(e){} })() }catch(e){}
                  }
                }catch(e){
                  try {
                    // final fallback: attempt to persist sanitized index into localStorage
                    try{ (() => { try{ if(window.storageAdapter && typeof window.storageAdapter.setJSON === 'function'){ window.storageAdapter.setJSON('fotosClientes', index); } else if(window.storageAdapter && typeof window.storageAdapter.setRaw === 'function'){ try{ window.storageAdapter.setRaw('fotosClientes', JSON.stringify(index)); }catch(e){} } else { try{ (typeof window.setFotosMap==='function' ? window.setFotosMap(index) : localStorage.setItem('fotosClientes', JSON.stringify(index))); }catch(e){} } }catch(e){} })() }catch{}
                  } catch {}
                }
              } catch(e){}
            }
