...
app.post('/bootstrap-admin', async (req, res) => {
  ...
  try {
    ...
    const userId = (globalThis.crypto?.randomUUID ? globalThis.crypto.randomUUID() : require('crypto').randomUUID());

    // IMPORTANT: ensure `db` is defined at this point in your server.js.
