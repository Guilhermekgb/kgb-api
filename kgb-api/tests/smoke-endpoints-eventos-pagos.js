#!/usr/bin/env node
/* Smoke test para endpoints usados por eventos-pagos.html
   Requisitos: NODE >= 18 (fetch disponível)
   Variáveis de ambiente opcionais: BASE_URL, KGB_EMAIL, KGB_SENHA
   Uso: KGB_EMAIL=admin@buffet.com KGB_SENHA=123456 node smoke-endpoints-eventos-pagos.js
*/
...
async function run(){
  console.log('SMOKE endpoints eventos-pagos — BASE =', BASE);
